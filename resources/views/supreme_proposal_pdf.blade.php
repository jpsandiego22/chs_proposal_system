<html>
    ...
    <body class="proxima">
                ...
                <td width="50%" valign="top" style="padding-left:10px;padding-right:30px;valign: top;">
                    <div style="padding:1px">
                        ...
                        <table style="border:1px solid black;" width="100%">
                            ...
                            <tr>
                                <td  class="cbproxima" colspan="2" style="border:1px solid black;padding:5px;background-color:#C8C7CB"></td>
                            </tr>
                            <tr>
        ...
        <table width="100%" class=" table-sched" style="font-size: 11px;">
            ...
            <tr>
                <td class="cbproxima" align="right" style="padding-right:3px;font-size: 11px;;line-height: 0.8;" nowrap>Max. Aggregate <br>Coverage/Per year</td>
                <?php 
                    $paying_period = 0;
                    $bonus_period = 0;
                    $p = 0;
                ...
                @foreach($collect[0]->coverage_roomrate as $row)
                    ...
                    <?php if($p == 2)
                    {
                        $last_coverage = $row->max_coverage;
                    }
                    $p++;?>
            ...
            <tr>
                <th></th>
                <td class="cbproxima" colspan='{{$collect[0]->policy_year}}' style="border:1px solid black;"><center>Supreme Period</center></td>
            </tr>
            <tr>
                <td class="cbproxima" style="line-height: 0.8;padding-right:3px"  align="right">
                    Policy Year
            ...
            <!-- <tr>
                <th></th>
                <td class="cbproxima" colspan='{{$collect[0]->policy_year}}'><center>Supreme Period</center></td>
            </tr> --> 
                <th></th>
                <td class="cbproxima " colspan='{{$collect[0]->policy_year}}' style="line-height: normal;font-size: 13px;border:1px solid black;"> 
                    <center>
            ...
            <tr>
                <th></th>
                <td class="cbproxima" colspan='{{$collect[0]->policy_year}}' style="line-height: 1;font-size: 8px;padding-top:2px"> 
                    <center><i>
                        In case the MBF is exhausted, Caritas shall no longer be liable and the Member shall be responsible for all excess charges.
                        This agreement shall then be considered terminated and all obligations of CARITAS deemed fully complied with.<br>( Art VI.2.a.2 )
                    </i></center>
                </td>
            </tr>
        </table>
        ...
        <div style="page-break-before: always;width:100%;padding-left:15px;padding-top:10px;margin-left:15px">
        <br><br>
            <p class="tbproxima" style="margin-bottom:1px">IV. HEALTH CARE BENEFITS</p>
            @if($collect[0]->product_type == 0)
                @include("health_care_benefits.supreme")
            @endif
        </div>
    </body>
</html>
