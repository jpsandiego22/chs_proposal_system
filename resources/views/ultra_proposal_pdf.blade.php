<html>
    ...
    <body class="proxima">
        ...
        <p class="tbproxima" style="padding-bottom:10px;margin-bottom:1px;padding-top:10px">
            III. SCHEDULE OF BENEFITS
        </p>
        <table width="100%" class=" table-sched" style="font-size: 11px;">
            <tr>
                @if($collect[0]->product_iid == 3) 
                    <th width="20%" ></th>
                @elseif($collect[0]->product_iid == 4) 
                    <th width="20%" ></th> 
                @else 
                    <th></th> 
                @endif    
           
                <th width="auto" class="cbproxima" style="border:1px solid black;" colspan='{{$collect[0]->paying_period}}'><center>Paying Period</center></th>
                <th width="auto" class="cbproxima" style="border:1px solid black;" colspan='{{$collect[0]->bonus_period}}'><center>Bonus Period</center></th>
            </tr>
            <tr>
        ...
        <div style="page-break-before: always;width:100%;padding-left:5px;padding-top:10px;margin-left:5px">
            ...
            @if($collect[0]->product_type == 0)
                @include("health_care_benefits.ultra")
            @endif
        </div>
    </body>
</html>
