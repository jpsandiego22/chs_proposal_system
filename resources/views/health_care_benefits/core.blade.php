<table width="100%" style="font-size: 11px;font-family: Arial, Helvetica, sans-serif;" class="we">
    <tr>
        <td width="34%" style="padding-top:1px;padding-bottom:1px;margin-top:1px;margin-bottom:1px">
            ...
            <p class="mbproxima" style="padding-top:1px;padding-bottom:1px;margin-top:1px;margin-bottom:1px">D. Special Diagnostic Procedures</p>
            <p style="line-height: 1.1;padding-left:20px;padding-top:1px;padding-bottom:1px;margin-top:1px;margin-bottom:1px">
                X-ray<br>
            ...
            <table width="100%">
                <tr>
                    <td style="border:1px solid black" colspan="2" align="center">
                        @if($collect[0]->product_type == 1)
                            <b>{{$collect[0]->kiddie_name}}'s Benefits</b>
                        @else
                ...
                <tr>
                    ...
                    <td align="right" style="border:1px solid black" width="35%">
                        <p style="padding-left:2px;padding-top:1px;padding-bottom:1px;margin-top:1px;margin-bottom:1px">
                ...
                <tr>
                    <td style="border-left:1px solid black;border-right:1px solid black" width="65%">
                        <p style="padding-left:2px;padding-top:1px;padding-bottom:1px;margin-top:1px;margin-bottom:1px">
                            <b>Membership Privileges</b> 
                        </p>
                    </td>
                    <td style="border-left:1px solid black;border-right:1px solid black" width="35%">
                        <p style="padding-left:2px;padding-top:1px;padding-bottom:1px;margin-top:1px;margin-bottom:1px">
                ...
                <tr>
                    ...
                    <td align="right" style="border-left:1px solid black;border-right:1px solid black" width="35%">
                        <p style="padding-left:2px;padding-top:1px;padding-bottom:1px;margin-top:1px;margin-bottom:1px">
                ...
                <tr>
                    ...
                    <td align="right" style="border-left:1px solid black;border-right:1px solid black;border-bottom:1px solid black" width="35%">
                        <p style="padding-left:2px;padding-top:1px;padding-bottom:1px;margin-top:1px;margin-bottom:1px">
                ...
                <tr>
                    <td style="border-left:1px solid black;border-right:1px solid black;border-bottom:1px solid black" width="65%">
                        <p style="padding-left:2px;padding-top:1px;padding-bottom:1px;margin-top:1px;margin-bottom:1px">
                            Total Benefits
                        </p>
                    </td>
                    <td align="right" style="border-left:1px solid black;border:1px solid black;" width="35%">
                        <p style="font-size: 12px;padding-left:2px;padding-top:1px;padding-bottom:1px;margin-top:1px;margin-bottom:1px">
        ...
        <td style="padding-left:20px;padding-right:10px" width="34%" valign="top">
            ...
            <p style="line-height: 1.1;padding-left:20px;padding-top:1px;padding-bottom:1px;margin-top:1px;margin-bottom:1px">
                ...
                Flu and Pneumonia Immunization, excluding cost of <br>
        ...
        <td style="padding-left:20px;padding-right:10px" width="32%" valign="top">
            ...
            <p style="line-height: 1.1;padding-left:20px;padding-top:1px;padding-bottom:1px;margin-top:1px;margin-bottom:60px">
                ...
                Up to Four (4) medical consultations per year for one<br>
                (1) pre-designated dependent, who is qualified as <br>
            ...
            @if($collect[0]->insurance_coverability == 0)
                ...
                <p class="cbproxima_with_h" style="font-size: 12px;line-height: 1.1;padding-left:60px;padding-top:1px;padding-bottom:1px;margin-top:1px;margin-bottom:30%">
                    ...
                    3. Term Life<br>
                    4. Waiver of Installment due to <br>&nbsp;&nbsp;&nbsp;&nbsp;Disability
                </p>
            @endif
